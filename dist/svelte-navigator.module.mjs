import { SvelteComponent, init, safe_not_equal, create_slot, element, text, attr, insert, append, set_data, detach, space, empty, set_style, update_slot, transition_in, transition_out, component_subscribe, create_component, mount_component, destroy_component, group_outros, check_outros, compute_rest_props, assign, exclude_internal_props, get_spread_update, get_spread_object, set_attributes, listen } from 'svelte/internal';
import { tick, getContext, onMount, setContext, onDestroy, createEventDispatcher } from 'svelte';
...
const get_default_slot_context = ctx => ({
	params: isSSR ? get(/*params*/ ctx[9]) : /*$params*/ ctx[4],
...
function create_if_block_1(ctx) {
	...
	const switch_instance_spread_levels = [
		{ location: /*$location*/ ctx[2] },
		{ navigate: /*navigate*/ ctx[10] },
		isSSR ? get(/*params*/ ctx[9]) : /*$params*/ ctx[4],
		/*$$restProps*/ ctx[11]
	];
	...
	return {
		...
		p(ctx, dirty) {
			...
			? get_spread_update(switch_instance_spread_levels, [
					...
					dirty & /*isSSR, get, params, $params*/ 528 && get_spread_object(isSSR ? get(/*params*/ ctx[9]) : /*$params*/ ctx[4]),
...
export { Link, Route, Router, createHistory, createMemorySource, globalHistory, link, links, navigate, useFocus, useLocation, useMatch, useNavigate, useParams, useResolvable, useResolve };
